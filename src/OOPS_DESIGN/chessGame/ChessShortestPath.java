...
class ChessShortestPath {
	...
	/*Finds the shortest path between a start node and end node for a unweighed graph using Breadth First Search 

	  For Chess Shortest Path, the chess board is an unweighed graph where the current position of the knight 
	  is the visited node in Breadth First Search and the positions of the possible next moves are the adjacent nodes
